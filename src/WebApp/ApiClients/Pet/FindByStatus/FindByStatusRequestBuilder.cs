...
#nullable enable
        public async Task<List<WebApp.ApiClients.Models.Pet>?> GetAsync(Action<RequestConfiguration<FindByStatusRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<WebApp.ApiClients.Models.Pet>> GetAsync(Action<RequestConfiguration<FindByStatusRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif

...
using WebApp.ApiClients.Pet.FindByTags;
using WebApp.ApiClients.Pet.Item;
namespace WebApp.ApiClients.Pet {
    /// <summary>
    ...
    public class PetRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the WebApp.ApiClients.pet.item collection</summary>
...
#nullable enable
        public async Task<WebApp.ApiClients.Models.Pet?> PostAsync(WebApp.ApiClients.Models.Pet body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WebApp.ApiClients.Models.Pet> PostAsync(WebApp.ApiClients.Models.Pet body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WebApp.ApiClients.Models.Pet?> PutAsync(WebApp.ApiClients.Models.Pet body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WebApp.ApiClients.Models.Pet> PutAsync(WebApp.ApiClients.Models.Pet body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(WebApp.ApiClients.Models.Pet body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(WebApp.ApiClients.Models.Pet body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(WebApp.ApiClients.Models.Pet body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(WebApp.ApiClients.Models.Pet body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif

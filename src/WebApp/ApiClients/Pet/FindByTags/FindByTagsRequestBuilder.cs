...
namespace WebApp.ApiClients.Pet.FindByTags {
    /// <summary>
...
#nullable enable
        public async Task<List<WebApp.ApiClients.Models.Pet>?> GetAsync(Action<RequestConfiguration<FindByTagsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<WebApp.ApiClients.Models.Pet>> GetAsync(Action<RequestConfiguration<FindByTagsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            var collectionResult = await RequestAdapter.SendCollectionAsync<WebApp.ApiClients.Models.Pet>(requestInfo, WebApp.ApiClients.Models.Pet.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
